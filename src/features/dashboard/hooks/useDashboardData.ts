...
import { useDashboardCreditCards } from './useDashboardCreditCards';
...
export function useDashboardData() {
  ...
  // ─── Credit card metrics ───
  const { creditCardWallets, creditCardDueReminders, creditCardCycleSummaries, creditCardMonths6, paymentDisciplineSummary, balanceTrend } = useDashboardCreditCards(wallets, cashLogs, selectedWallet, selectedMonth, monthlyTrend);
